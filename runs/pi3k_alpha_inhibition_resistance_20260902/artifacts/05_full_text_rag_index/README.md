...
This stage flattens normalized Stage 5 full-text chunks into a run-local chunk manifest, mirrors chunk records into SQLite, builds a BM25 lexical index, and optionally builds a Qdrant semantic index with `text-embedding-3-small`.
